(function initSharedScope(globalScope) {
  ...
  const ERROR_MESSAGES = Object.freeze({
    ...
    E_COUNTER_TIMEOUT: "数量を操作するボタンが見つかりませんでした。ページを再読み込みして再試行してください。",
    E_QTY_ADJUST_FAILED: "数量の調整に失敗しました。ページ状態を確認してください。",
    E_AGREEMENT_NOT_CHECKED: "同意チェックを操作できませんでした。ページ状態を確認してください。",
    ...
    E_EXECUTION_FAILED: "実行に失敗しました。ページ状態を確認して再試行してください。",
    E_WAIT_TIMEOUT: "ページの読み込みを待機できませんでした。少し待ってから再試行してください。",
    ...
    E_TICKET_PAGE_REQUIRED: "escape.id のチケットページ（公演ページ）を開いてください。",
